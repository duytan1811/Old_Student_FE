...
import { SettingMajorEditModalComponent } from '../setting-major-edit-modal/setting-major-edit-modal.component';
import { SettingMajorImportModalComponent } from '../setting-major-import-modal/setting-major-import-modal.component';
...
export class SettingMajorComponent implements OnInit {
  ...
  public tables$: Observable<Array<MajorModel>>;
  ...
  ngOnInit(): void {
    ...
    this.tables$ = this.majorState.majors$;
  ...
  public getStatusString(statusKey?: number) {
    const result = this.commonState.getStatusString(statusKey);
    return result;
  }
